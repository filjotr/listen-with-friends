    ...
    <div className="min-h-screen flex justify-center items-center px-4 pt-16 bg-[var(--base-bg)] text-main">
      <div className="w-full max-w-md glass-panel p-8 md:p-10 rounded-3xl z-10 flex flex-col">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex p-3 rounded-full neumorph-btn text-brandPink mb-4">
            <Music className="w-6 h-6" />
          </div>
          <h2 className="text-3xl font-extrabold text-main">Create Account</h2>
          <p className="text-muted text-sm mt-2">Get synced with your group</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="flex flex-col space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-2.5 rounded-xl glass-input text-sm text-main"
              />
            </div>
          </div>

          <div className="flex flex-col space-y-1.5">
            <label className="text-xs text-muted font-semibold uppercase tracking-wider">Email Address</label>
            <div className="relative">
              <span className="absolute inset-y-0 left-0 pl-3.5 flex items-center text-muted">
          ...
          >
            <UserPlus className="w-4 h-4 text-brandPink" />
